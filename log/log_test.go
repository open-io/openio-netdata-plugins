...
var keysToCheck = []string{
	"bandwidth_in_DELETE_OPENIO-rawx-0",
	"response_time_min_DELETE_OPENIO-oioswift-0.content_delete",
	"response_time_max_DELETE_OPENIO-oioswift-0.content_delete",
	...
	"response_time_max_DELETE_OPENIO-rawx-0",
	"response_time_avg_DELETE_OPENIO-rawx-0",
	"bandwidth_in_PUT_OPENIO-oioswift-0.content_create",
	"response_time_min_DELETE_OPENIO-rawx-0",
	"response_time_avg_DELETE_OPENIO-oioswift-0.content_delete",
	"bandwidth_out_DELETE_OPENIO-oioswift-0.content_delete",
	"response_time_min_PUT_OPENIO-oioswift-0.content_create",
	"response_time_max_PUT_OPENIO-oioswift-0.content_create",
	"response_time_avg_PUT_OPENIO-oioswift-0.content_create",
	"bandwidth_out_PUT_OPENIO-oioswift-0.content_create",
	"response_code_log_ops_DELETE.204.OPENIO-rawx-0",
	"bandwidth_out_DELETE_OPENIO-rawx-0",
	"bandwidth_in_DELETE_OPENIO-oioswift-0.content_delete",
}
